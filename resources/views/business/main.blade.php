<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Add Parent</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Dashboard/Add Parent</li>
            </ol>
            <form role="form" action="/store" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group">
                        <div class="col-xs-7">
                            <input name="Disc" type="text" class="form-control" id="" placeholder="" value="" required>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-right">
                <a href="/viewParent"><input type="button" style="background-color:purple"
                        class="btn btn-lg btn-success" name="View" value="View Parent" /></a>
            </div>
        </div>
    </main>