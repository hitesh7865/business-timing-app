            ...
            <form role="form" action="{{route('business.update',$business->id)}}" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group">
                        <div class="col-xs-7">
                            <input name="name" type="text" class="form-control" id="" placeholder="Enter Business Name" value="{{$business->name}}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group">
                        <div class="col-xs-7">
                            <input name="logo" type="file" value="{{ asset('storage/'.$business->logo)}}" accept=".jpg,.png,.jpeg">
                        </div>
                    </div>
                </div>
